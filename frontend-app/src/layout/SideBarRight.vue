<template>
  <div class="w-80 bg-white p-6 shadow-sm">
    ...
    <div class="space-y-4 mb-6">
      <div class="flex items-center space-x-3">
        ...
        <div class="flex-1">
          ...
          <p class="text-orange-custom font-semibold text-sm">
            ${{ item.price }}
          </p>
        </div>
...
const subtotal = computed(() => (item.value.price * item.value.quantity).toFixed(2))
